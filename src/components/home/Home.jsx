...
const Home = () => {
    ...
    useEffect(() => {
        // Batched animation using ScrollTrigger and custom batch function
        batch(animatedElementRef.current, {
            interval: 0.1,
            batchMax: 3,
    ...
    return (
        <div>
            ...
            <div className="page-main animated-element" id='page-main' ref={animatedElementRef}>

                <div className="details-col containers" id='details-col' ref={animatedElementRef}>
                    <Details />
                </div>
                <div className="details-col containers" id='details-col' ref={animatedElementRef}>
                    <Details />
